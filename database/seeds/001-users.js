  ...
  return knex('users').del()
    .then(function () {
      ...
      return knex('users').insert([
        { first_name: 'Lorenzo', last_name: 'Simpson', username: 'lorenzo-simpson', email: 'lsimp@hackathon-testing.com', password: 'testing' },
        { first_name: 'Austin', last_name: 'Powell', username: 'austin-powell', email: "apowe@hackathon-testing.com", password: 'testing' },
        { first_name: 'Alec', last_name: 'Blakeley', username: 'alec-blakeley', email: "ablak@hackathon-testing.com", password: 'testing' },
